...
y_train = reader.read_field('V_plane').permute(2,0,1)[training_idx]
y_train = y_train.reshape(ntrain, s1, r1, s2, r2).permute(0, 2, 4, 1, 3).reshape(ntrain * r1 * r2, s1, s2)

reader.load_file(TEST_PATH)
x_test = reader.read_field('P_plane').permute(2,0,1)[testing_idx]
