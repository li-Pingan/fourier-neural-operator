...
batch_size = 20
learning_rate = random.sample([0.0001, 0.001, 0.01, 0.1])

epochs = 100
step_size = random.sample([20, 50, 100, 150])
gamma = random.sample([0.1, 0.5, 0.8])

modes = random.sample([5, 10, 15, 20])
width = random.sample([10, 20, 30, 40])
